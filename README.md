...
<br><h1>Introdução</h1>
<p>Algoritmo guloso (ou míope) está presente em literatura e é uma solução comum para problemas de otimização, pois realiza a escolha que parece ser a melhor <b>no momento</b>, deste modo, espera-se que uma sucessão de boas escolhas irão previnir erros em nível global</p>
